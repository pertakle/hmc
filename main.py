...
parser.add_argument("--env", type=str, default="hmc/LightsOut-v0", help="id string of the env")
parser.add_argument("--env_size", type=int, default=5, help="size of the environment (if aplicable)")
...
parser.add_argument("--ep_limit", type=int, default=7, help="maximum length of an episode")
