...
def evaluate(agent: A2CCubeAgent, batch_size: int, sample_moves: int, limit: int, beam_size: int) -> None:
...
def train_her_cube(
    ...
    for step in range(1, steps + 1):
        states, actions, returns = data_gen.generate_batch(agent, train_episodes, train_sample_moves, train_ep_lim)
